ui <- fluidPage(
  ...
  tags$head(includeHTML(("data/google_analytics_v1.html"))),
  
  titlePanel(title=div(img(src="cipr_logo_small.png"), "Cluster identity predictor (v1_playground)"), windowTitle = "CIPR"),
