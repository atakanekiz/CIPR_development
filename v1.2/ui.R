...
ui <- fluidPage(
  ...
  tags$head(includeHTML(("data/google_analytics_v1.2.html"))),
  
  titlePanel(title=div(img(src="cipr_logo_small.png"), "Cluster identity predictor (v1.2)"), windowTitle = "CIPR"),
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("How to use this program",
                 ...
                 tags$ul(
                   tags$li("This program is pre-loaded with ImmGen microarray data (v1 and v2 microarray releases combined) for easily investigating immune cells in SCseq experiments"),
                 ...
                 h3("CIPR Version v1.2"),
                 p("ImmGen V2 datasets are added to the reference data frame. This dataset was generated by using the same microarray platform, but normalized independently because ~8% of the probesets could not be fitted reliably. Comparing V1 and V2 data in broad sense is fine but fine, gene-level comparisons may be unreliable. For further information see", a('ImmGen post on social media',href='https://bit.ly/2GAvCJy')),
